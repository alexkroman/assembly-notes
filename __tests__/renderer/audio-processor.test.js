...
import { AudioWorkletProcessor, registerProcessor, } from '../../__mocks__/audio-context';
// Set up global mocks
...
describe('AudioProcessor', () => {
    ...
    beforeEach(async () => {
        ...
        const registerProcessorCall = global.registerProcessor.mock.calls.find((call) => call[0] === 'audio-processor');
    ...
    describe('registerProcessor', () => {
        it('should register the audio-processor', () => {
            expect(global.registerProcessor).toHaveBeenCalledWith('audio-processor', AudioProcessor);
        });
    });
});
