...
describe('AutoUpdaterUI Module', () => {
    ...
    describe('initAutoUpdaterUI', () => {
        it('should set up event listeners', () => {
            ...
            expect(mockElectronAPI.onUpdateAvailable).toHaveBeenCalledWith(AutoUpdaterUI.handleUpdateAvailable);
            expect(mockElectronAPI.onDownloadProgress).toHaveBeenCalledWith(AutoUpdaterUI.handleDownloadProgress);
            expect(mockElectronAPI.onUpdateDownloaded).toHaveBeenCalledWith(AutoUpdaterUI.handleUpdateDownloaded);
        });
    });
...
//# sourceMappingURL=auto-updater-ui.test.js.map