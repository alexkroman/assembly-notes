...
describe('TranscriptionService', () => {
  ...
  describe('start', () => {
    ...
    it('should reset connection state on start', async () => {
      ...
      expect(transcriptionService.connectionState.microphone.retryCount).toBe(
        0
      );
  ...
  describe('stop', () => {
    ...
    it('should clear retry timeouts', async () => {
      ...
      transcriptionService.connectionState.microphone.retryTimeout = setTimeout(
        () => {},
        1000
      );
  ...
  describe('sendMicrophoneAudio', () => {
    ...
    it('should send audio data to microphone transcriber', () => {
      ...
      expect(mockTranscriber.sendAudio).toHaveBeenCalledWith(
